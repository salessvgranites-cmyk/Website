...
export default function Home() {
  ...
  const enquiryMutation = trpc.site.enquiry.useMutation({ onSuccess: () => { toast.success("Thank you — we’ll be in touch shortly."); setForm({ name: "", email: "", phone: "", projectType: "", message: "" }); }, onError: () => toast.error("Please check the details and try again.") });
          ...
          <div className="relative z-10 mx-auto grid max-w-[1400px] items-center gap-14 lg:grid-cols-[0.85fr_1fr]">
            ...
            <div className="max-w-xl">
              ...
              <div className="mt-12 grid grid-cols-3 gap-6 border-t border-white/15 pt-7">
                ...
                <div>
                  <div className="font-serif text-4xl text-ivory">18</div>
                  <div className="mt-2 text-[10px] uppercase tracking-[0.18em] text-ivory/45">States served</div>
                </div>
                <div>
                  <div className="font-serif text-4xl text-gold">01</div>
                  <div className="mt-2 text-[10px] uppercase tracking-[0.18em] text-ivory/45">Standard: exacting</div>
                </div>
              </div>
            </div>
          </div>
