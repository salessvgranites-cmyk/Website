...
export default function Home() {
  ...
  // 5 Stones Collection requested by user
  const stoneCollection = [
    {
      name: "INDIAN BLACK GRANITE",
      description: "Deep graphite · Mineral rhythm\nTimeless elegance",
      image: "/images/indian-black.jpg"
    },
    {
      name: "ABSOLUTE BLACK GRANITE",
      description: "Deep black · Consistent texture\nHigh polish",
      image: "/images/absolute-black.jpg"
    },
    {
      name: "STEEL GREY GRANITE",
      description: "Layered grey · Sculptural presence\nPolished finish",
      image: "/images/steel-grey.jpg"
    },
    {
      name: "BLACK GALAXY GRANITE",
      description: "Sparkling darks · Radiant golden flecks\nHigh durability",
      image: "/images/black-galaxy.jpg"
    },
    {
      name: "TAN BROWN GRANITE",
      description: "Warm brown · Distinctive pattern\nVersatile application",
  ...
  // 7 Surface Finishes requested by user
  const finishesCollection = [
    {
      name: "POLISHED FINISH",
      tagline: "High gloss mirror reflection",
      description: "Brings out the deepest color saturation, crystalline depth, and mineral contrast. Impervious and pristine.",
      image: "/images/absolute-black.jpg",
      badge: "Classic Elegance"
    },
    {
      name: "HONED FINISH",
      tagline: "Smooth matte velvet surface",
      description: "Non-reflective satin touch with subtle diffusion. Ideal for contemporary interior walls, floors, and vanity counters.",
      image: "/images/noir-vein.jpg",
      badge: "Architectural Satin"
    },
    {
      name: "FLAMED FINISH",
      tagline: "Thermal textured slip-resistance",
      description: "Exposed to intense high-temperature flame causing surface crystals to burst into a rough, non-slip textured face.",
      image: "/images/steel-grey.jpg",
      badge: "Exterior Grade"
    },
    {
      name: "LEATHERED FINISH",
      tagline: "Tactile undulating leather feel",
      description: "Diamond-tipped brush texturing that retains natural grain contour while offering a warm, soft antique grip.",
      image: "/images/tan-brown.jpg",
      badge: "Warm Tactility"
    },
    {
      name: "BUSH HAMMERED FINISH",
      tagline: "Uniformly pitted rustic texture",
      description: "Hydraulic impact chiseling produces an evenly pitted stone relief. Perfect for outdoor walkways, steps, and plazas.",
      image: "/images/cloud-ledger.jpg",
      badge: "Heavy Duty"
    },
    {
      name: "WATERJET FINISH",
      tagline: "Micro-etched natural stone relief",
      description: "High-pressure hydrodynamic washing that preserves the stone's genuine color tone while generating non-skid relief.",
      image: "/images/waterfall.jpg",
      badge: "Modern Textured"
    },
    {
      name: "CUT-TO-SIZE & EDGE PROFILING",
      tagline: "CNC bevel, bullnose & mitred joints",
      description: "Custom precision fabrication according to international architectural blueprints, monument specs, and facade details.",
    ...
    <div className="min-h-screen bg-[#0d0f12] text-[#e8e6e1] selection:bg-[#c8a35f] selection:text-[#0d0f12]">
        ...
        {menuOpen && (
          <div className="border-b border-white/10 bg-[#121519] px-6 py-6 md:hidden">
            <div className="flex flex-col gap-4 text-xs font-semibold uppercase tracking-[0.22em] text-[#9ca3af]">
              <button onClick={() => scrollToSection("top")} className="text-left hover:text-white py-1">HOME</button>
              <button onClick={() => scrollToSection("about")} className="text-left hover:text-white py-1">ABOUT</button>
              <button onClick={() => scrollToSection("products")} className="text-left hover:text-white py-1">PRODUCTS</button>
      ...
      <main id="top">
          ...
          <div className="relative z-10 mx-auto w-full max-w-[1440px] px-6 lg:px-12 py-16 lg:py-24">
            <div className="max-w-2xl">
              ...
              <h1 className="font-cinzel text-4xl sm:text-5xl lg:text-[4rem] font-semibold leading-[1.08] tracking-tight text-white mb-6">
                Sri Venkateswara<br />
                <span className="text-[#c8a35f]">Granites.</span>
              </h1>

              {/* Subtext */}
              <p className="text-sm sm:text-base text-gray-300 font-normal leading-relaxed max-w-lg mb-8">
                Premium Indian granite products manufactured and prepared for international markets.
              </p>
          ...
          <div className="mx-auto max-w-[1440px] px-6 lg:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-10 lg:gap-14 items-start">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                {/* Card 1: Granite Slabs */}
                <div className="group cursor-pointer">
                  <div className="aspect-[4/3] overflow-hidden bg-gray-200 mb-4 border border-black/5 shadow-sm">
                    <img 
                      src="/images/slabs-warehouse.jpg" 
                      alt="Granite Slabs in factory warehouse" 
                  ...
                  <p className="text-[11px] text-[#6d675d] leading-snug">
                    Premium granite surfaces selected for consistency, colour and finish.
                  </p>
                </div>

                {/* Card 2: Granite Monuments */}
                <div className="group cursor-pointer">
                  <div className="aspect-[4/3] overflow-hidden bg-gray-200 mb-4 border border-black/5 shadow-sm">
                    <img 
                      src="/images/monument-headstone.jpg" 
                      alt="Granite memorial monument headstone" 
                      className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105"
                    />
                  </div>
                  <div className="mb-1.5">
                  ...
                  <p className="text-[11px] text-[#6d675d] leading-snug">
                    Precision-crafted memorial products designed for international markets.
                  </p>
                </div>

                {/* Card 3: Granite Vases */}
                <div className="group cursor-pointer">
                  <div className="aspect-[4/3] overflow-hidden bg-gray-200 mb-4 border border-black/5 shadow-sm">
                    <img 
                      src="/images/vases-collection.jpg" 
                      alt="Granite vases collection" 
                      className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105"
                    />
                  </div>
                  <div className="mb-1.5">
                  ...
                  <p className="text-[11px] text-[#6d675d] leading-snug">
                    Elegant granite accessories crafted for memorial and landscaping applications.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-[1440px]">
            <div className="grid grid-cols-1 lg:grid-cols-[48%_52%] items-stretch">
              ...
              <div className="p-8 lg:p-14 flex flex-col justify-center">
                ...
                <h2 className="font-cinzel text-3xl sm:text-4xl font-semibold leading-tight text-[#151310] mb-4">
                  NATURE CREATES IT.<br />WE PERFECT IT.
                </h2>
                <p className="text-sm text-[#5c5447] leading-relaxed mb-8 max-w-xl">
                  From raw granite selection to cutting, shaping, polishing, finishing and export packaging, every stage is handled with attention to detail.
                </p>
        ...
        <section id="facility" className="bg-[#edeae1] text-[#151310] py-16 lg:py-24 border-b border-black/10">
          <div className="mx-auto max-w-[1440px] px-6 lg:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] gap-12 lg:gap-14 items-start">
              
              {/* Left Column: Facility Progression & Built to Travel */}
              <div>
                <div className="text-[10px] font-bold uppercase tracking-[0.28em] text-[#847968] mb-2">
                  OUR FACILITY
                </div>
                ...
                {/* Built to Travel Banner */}
                {/* Contact Information */}
                <div className="mt-8 space-y-6">
                  <a href="tel:+919790613468" className="flex items-start gap-4 hover:opacity-80 transition-opacity group">
                    <Phone className="w-5 h-5 text-[#c8a35f] shrink-0" />
                    <div>
                      <div className="text-[15px] font-medium text-[#151310]">9790613468</div>
                    </div>
                  </a>
                  <a href="mailto:sales.svgranites@gmail.com" className="flex items-start gap-4 hover:opacity-80 transition-opacity group">
                    <Mail className="w-5 h-5 text-[#c8a35f] shrink-0" />
                    <div>
                      <div className="text-[15px] font-medium text-[#151310]">sales.svgranites@gmail.com</div>
                    </div>
                  </a>
                  <a href="https://maps.app.goo.gl/uCjECLRFDfC87n3R9?g_st=ic" target="_blank" rel="noopener noreferrer" className="flex items-start gap-4 hover:opacity-80 transition-opacity group">
                    <MapPin className="w-5 h-5 text-[#c8a35f] shrink-0" />
                    <div>
                      <div className="text-[15px] font-medium text-[#151310] leading-relaxed max-w-sm">
                        NO.951/3,Poovallikuppam Village Kadampathur Block, Post, Mappedu, Chennai, Tamil Nadu 602105
                      </div>
                    </div>
                  </a>
                  <a href="https://wa.me/919790613468" target="_blank" rel="noopener noreferrer" className="flex items-start gap-4 hover:opacity-80 transition-opacity group">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-5 text-gray-400">
              ...
              <span className="text-[10px] text-gray-500 tracking-wider">
                © 2026 SV Granites. All rights reserved.
              </span>
            </div>
          </div>
        </div>
